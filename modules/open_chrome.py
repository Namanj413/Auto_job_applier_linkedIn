...
def createChromeSession(isRetry: bool = False):
    ...
    if stealth_mode:
        ...
        try:
            ...
            print_lg("Undetected mode failed, falling back to standard Chrome WebDriver.", e)
