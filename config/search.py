...
search_terms = ["React JS", "React Developer", "Frontend Developer", "Frontend Engineer", "Web Developer", "Software Engineer", "UI Developer"]
...
* question_1 = "What is your current CTC (in LPA)?"                  # "14,00,000", "answer2", "answer3" or ("" to not select). Answers are case sensitive.
...
about_company_bad_words = ["Crossover","Jobs Ai","Hired","Crossing Hurdles"]       # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
about_company_good_words = ["React","react","React.js","react.js","React js","react js","Next.js","Next js"]      # (dynamic multiple search) or leave empty as []. Ex: ["Robert Half", "Dice"]

# Avoid applying to these companies if they have these bad words in their 'Job Description' section...  (In development)
bad_words = ["Full Stack","Full-Stack","Full-stack","PHP","Python",".net",".Net",".NET",".NET/.NET Core","C++","Spring Boot"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
